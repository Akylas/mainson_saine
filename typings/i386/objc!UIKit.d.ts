...
declare class UIButton extends UIControl implements NSCoding, UIAccessibilityContentSizeCategoryImageAdjusting, UISpringLoadedInteractionSupporting {
	...
	readonly sd_currentBackgroundImageURL: NSURL;

	readonly sd_currentImageURL: NSURL;
	...
	sd_backgroundImageURLForState(state: UIControlState): NSURL;

	sd_cancelBackgroundImageLoadForState(state: UIControlState): void;

	sd_cancelImageLoadForState(state: UIControlState): void;

	sd_imageURLForState(state: UIControlState): NSURL;

	sd_setBackgroundImageWithURLForState(url: NSURL, state: UIControlState): void;

	sd_setBackgroundImageWithURLForStateCompleted(url: NSURL, state: UIControlState, completedBlock: (p1: UIImage, p2: NSError, p3: SDImageCacheType, p4: NSURL) => void): void;

	sd_setBackgroundImageWithURLForStatePlaceholderImage(url: NSURL, state: UIControlState, placeholder: UIImage): void;

	sd_setBackgroundImageWithURLForStatePlaceholderImageCompleted(url: NSURL, state: UIControlState, placeholder: UIImage, completedBlock: (p1: UIImage, p2: NSError, p3: SDImageCacheType, p4: NSURL) => void): void;

	sd_setBackgroundImageWithURLForStatePlaceholderImageOptions(url: NSURL, state: UIControlState, placeholder: UIImage, options: SDWebImageOptions): void;

	sd_setBackgroundImageWithURLForStatePlaceholderImageOptionsCompleted(url: NSURL, state: UIControlState, placeholder: UIImage, options: SDWebImageOptions, completedBlock: (p1: UIImage, p2: NSError, p3: SDImageCacheType, p4: NSURL) => void): void;

	sd_setBackgroundImageWithURLForStatePlaceholderImageOptionsContext(url: NSURL, state: UIControlState, placeholder: UIImage, options: SDWebImageOptions, context: NSDictionary<string, any>): void;

	sd_setBackgroundImageWithURLForStatePlaceholderImageOptionsContextProgressCompleted(url: NSURL, state: UIControlState, placeholder: UIImage, options: SDWebImageOptions, context: NSDictionary<string, any>, progressBlock: (p1: number, p2: number, p3: NSURL) => void, completedBlock: (p1: UIImage, p2: NSError, p3: SDImageCacheType, p4: NSURL) => void): void;

	sd_setBackgroundImageWithURLForStatePlaceholderImageOptionsProgressCompleted(url: NSURL, state: UIControlState, placeholder: UIImage, options: SDWebImageOptions, progressBlock: (p1: number, p2: number, p3: NSURL) => void, completedBlock: (p1: UIImage, p2: NSError, p3: SDImageCacheType, p4: NSURL) => void): void;

	sd_setImageWithURLForState(url: NSURL, state: UIControlState): void;

	sd_setImageWithURLForStateCompleted(url: NSURL, state: UIControlState, completedBlock: (p1: UIImage, p2: NSError, p3: SDImageCacheType, p4: NSURL) => void): void;

	sd_setImageWithURLForStatePlaceholderImage(url: NSURL, state: UIControlState, placeholder: UIImage): void;

	sd_setImageWithURLForStatePlaceholderImageCompleted(url: NSURL, state: UIControlState, placeholder: UIImage, completedBlock: (p1: UIImage, p2: NSError, p3: SDImageCacheType, p4: NSURL) => void): void;

	sd_setImageWithURLForStatePlaceholderImageOptions(url: NSURL, state: UIControlState, placeholder: UIImage, options: SDWebImageOptions): void;

	sd_setImageWithURLForStatePlaceholderImageOptionsCompleted(url: NSURL, state: UIControlState, placeholder: UIImage, options: SDWebImageOptions, completedBlock: (p1: UIImage, p2: NSError, p3: SDImageCacheType, p4: NSURL) => void): void;

	sd_setImageWithURLForStatePlaceholderImageOptionsContext(url: NSURL, state: UIControlState, placeholder: UIImage, options: SDWebImageOptions, context: NSDictionary<string, any>): void;

	sd_setImageWithURLForStatePlaceholderImageOptionsContextProgressCompleted(url: NSURL, state: UIControlState, placeholder: UIImage, options: SDWebImageOptions, context: NSDictionary<string, any>, progressBlock: (p1: number, p2: number, p3: NSURL) => void, completedBlock: (p1: UIImage, p2: NSError, p3: SDImageCacheType, p4: NSURL) => void): void;

	sd_setImageWithURLForStatePlaceholderImageOptionsProgressCompleted(url: NSURL, state: UIControlState, placeholder: UIImage, options: SDWebImageOptions, progressBlock: (p1: number, p2: number, p3: NSURL) => void, completedBlock: (p1: UIImage, p2: NSError, p3: SDImageCacheType, p4: NSURL) => void): void;
...
declare class UICollectionViewController extends UIViewController implements UICollectionViewDataSource, UICollectionViewDelegate, UIGestureRecognizerDelegate {
...
declare class UIFont extends NSObject implements NSCopying {
	...
	static fontWithCTFont(ctFont: UIFont): UIFont;
...
declare class UIImage extends NSObject implements NSItemProviderReading, NSItemProviderWriting, NSSecureCoding, UIAccessibilityIdentification, UIItemProviderPresentationSizeProviding {
	...
	static imageWithContentsOfURLCachePolicyError(URL: NSURL, cachePolicy: NSURLRequestCachePolicy): UIImage;

	static imageWithData(data: NSData): UIImage;

	static imageWithDataScale(data: NSData, scale: number): UIImage;

	static imageWithSolidColorSize(color: UIColor, size: CGSize): UIImage;
	...
	static sd_decodedAndScaledDownImageWithImage(image: UIImage): UIImage;

	static sd_decodedAndScaledDownImageWithImageLimitBytes(image: UIImage, bytes: number): UIImage;

	static sd_decodedImageWithImage(image: UIImage): UIImage;

	static sd_imageWithData(data: NSData): UIImage;

	static sd_imageWithDataScale(data: NSData, scale: number): UIImage;

	static sd_imageWithDataScaleFirstFrameOnly(data: NSData, scale: number, firstFrameOnly: boolean): UIImage;

	static sd_imageWithGIFData(data: NSData): UIImage;
	...
	sd_extendedObject: any;

	sd_imageFormat: number;

	sd_imageLoopCount: number;

	readonly sd_isAnimated: boolean;

	sd_isDecoded: boolean;

	sd_isIncremental: boolean;

	readonly sd_isVector: boolean;

	sd_memoryCost: number;
	...
	dataForPNGRepresentation(): NSData;
	...
	drawInRectWithContentMode(rect: CGRect, contentMode: UIViewContentMode): void;
	...
	imageMaskedAndTintedWithColor(color: UIColor): UIImage;

	imageScaledToSize(newSize: CGSize): UIImage;
	...
	sd_blurredImageWithRadius(blurRadius: number): UIImage;

	sd_colorAtPoint(point: CGPoint): UIColor;

	sd_colorsWithRect(rect: CGRect): NSArray<UIColor>;

	sd_croppedImageWithRect(rect: CGRect): UIImage;

	sd_filteredImageWithFilter(filter: CIFilter): UIImage;

	sd_flippedImageWithHorizontalVertical(horizontal: boolean, vertical: boolean): UIImage;

	sd_imageData(): NSData;

	sd_imageDataAsFormat(imageFormat: number): NSData;

	sd_imageDataAsFormatCompressionQuality(imageFormat: number, compressionQuality: number): NSData;

	sd_imageDataAsFormatCompressionQualityFirstFrameOnly(imageFormat: number, compressionQuality: number, firstFrameOnly: boolean): NSData;

	sd_resizedImageWithSizeScaleMode(size: CGSize, scaleMode: SDImageScaleMode): UIImage;

	sd_rotatedImageWithAngleFitSize(angle: number, fitSize: boolean): UIImage;

	sd_roundedCornerImageWithRadiusCornersBorderWidthBorderColor(cornerRadius: number, corners: UIRectCorner, borderWidth: number, borderColor: UIColor): UIImage;

	sd_tintedImageWithColor(tintColor: UIColor): UIImage;

	self(): this;

	stretchableImageWithLeftCapWidthTopCapHeight(leftCapWidth: number, topCapHeight: number): UIImage;

	tileImageAtColumnOfColumnsRowOfRows(column: number, columns: number, row: number, rows: number): UIImage;

	tileImageInClipRectInBoundsScale(clipRect: CGRect, bounds: CGRect, scale: number): UIImage;
}
...
declare class UILabel extends UIView implements NSCoding, NYTPhotoCaptionViewLayoutWidthHinting, UIContentSizeCategoryAdjusting {
...
declare class UIView extends UIResponder implements CALayerDelegate, NSCoding, UIAccessibilityIdentification, UIAppearance, UIAppearanceContainer, UICoordinateSpace, UIDynamicItem, UIFocusItem, UIFocusItemContainer, UILargeContentViewerItem, UITraitEnvironment {
	...
	sd_imageProgress: NSProgress;

	sd_imageTransition: SDWebImageTransition;

	readonly sd_imageURL: NSURL;

	readonly sd_latestOperationKey: string;
	...
	addShadowWithColorAlphaRadiusOffset(color: UIColor, alpha: number, radius: number, offset: CGSize): void;
	...
	sd_cancelCurrentImageLoad(): void;

	sd_cancelImageLoadOperationWithKey(key: string): void;

	sd_imageLoadOperationForKey(key: string): SDWebImageOperation;

	sd_internalSetImageWithURLPlaceholderImageOptionsContextSetImageBlockProgressCompleted(url: NSURL, placeholder: UIImage, options: SDWebImageOptions, context: NSDictionary<string, any>, setImageBlock: (p1: UIImage, p2: NSData, p3: SDImageCacheType, p4: NSURL) => void, progressBlock: (p1: number, p2: number, p3: NSURL) => void, completedBlock: (p1: UIImage, p2: NSData, p3: NSError, p4: SDImageCacheType, p5: boolean, p6: NSURL) => void): void;

	sd_removeImageLoadOperationWithKey(key: string): void;

	sd_setImageLoadOperationForKey(operation: SDWebImageOperation, key: string): void;
	...
	setDispatcherView(view: UIView): void;
	...
	setRoundedCornersWithRadiusWidthColor(radius: number, width: number, color: UIColor): void;
	...
	updateShadowPathToBoundsWithDuration(bounds: CGRect, duration: number): void;
...
declare class UIViewController extends UIResponder implements NSCoding, NSExtensionRequestHandling, UIAppearanceContainer, UIContentContainer, UIFocusEnvironment, UIStateRestoring, UITraitEnvironment {
	...
	readonly mdc_bottomSheetPresentationController: MDCBottomSheetPresentationController;
